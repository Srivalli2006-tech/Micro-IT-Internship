"""Basically the user will forget the password if they give some complex or random values"""
"""so here we are generating the password by user details
(their name, birth_year, special characters and again the name is repeated from reverse order)"""
